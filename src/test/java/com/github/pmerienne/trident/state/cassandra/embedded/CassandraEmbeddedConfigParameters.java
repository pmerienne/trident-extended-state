...
public class CassandraEmbeddedConfigParameters {
	...
	public static final String DEFAULT_TEST_KEYSPACE_NAME = "trident_ex_state";

	static final String DEFAULT_TEST_DATA_FOLDER = "target/cassandra_embedded/data";

	static final String DEFAULT_TEST_COMMIT_LOG_FOLDER = "target/cassandra_embedded/commitlog";

	static final String DEFAULT_TEST_SAVED_CACHES_FOLDER = "target/cassandra_embedded/saved_caches";

	static final Set<String> DEFAULT_TEST_FOLDERS = ImmutableSet.of(DEFAULT_TEST_DATA_FOLDER,
			DEFAULT_TEST_COMMIT_LOG_FOLDER, DEFAULT_TEST_SAVED_CACHES_FOLDER);

	static final String DEFAULT_TEST_CONFIG_YAML_FILE = "target/cassandra_embedded/cassandra.yaml";

	static final String DEFAULT_CASSANDRA_EMBEDDED_CLUSTER_NAME = "Trident Extended State Cluster";

	static final String DEFAULT_CASSANDRA_EMBEDDED_KEYSPACE_NAME = "trident_ex_state";
	...
	static Map<String, Object> mergeWithDefaultParameters(Map<String, Object> parameters) {
		...
		defaultParams.put(DATA_FILE_FOLDER, DEFAULT_TEST_DATA_FOLDER);
		defaultParams.put(COMMIT_LOG_FOLDER, DEFAULT_TEST_COMMIT_LOG_FOLDER);
		defaultParams.put(SAVED_CACHES_FOLDER, DEFAULT_TEST_SAVED_CACHES_FOLDER);
		defaultParams.put(CONFIG_YAML_FILE, DEFAULT_TEST_CONFIG_YAML_FILE);
